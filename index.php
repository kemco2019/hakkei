...
<body>
    ...
    <div class = "mobile_box mobile">
        <div class="mobile_item">
            <a href="select.html" class = "allpiece">全ての<br>ピースを<br>見る</a>
        </div>
        <div class="mobile_item" background="images_page1/top_phone.png">
            <div class="piece_container">
                <?php
                    echo '<div class="piece_container_item">';
                    echo '<h1>Ranking</h1> <br>';
                    echo '</div>';
                    ...
                    for ($i = 0; $i < $viewMAX; $i++ ) {
                        ...
                        echo '<div class="Rank_viewItem" style="font-size=100px">';
                        echo ($i + 1) ;
                        echo '</div>';
